<template>
  <div>
    <button class="relative inline-block transition rounded-full hover:shadow-lg">
      ...
      <span class="absolute top-0 right-0 block w-3 h-3 bg-green-400 rounded-full ring-2 ring-white" />
    </button>
  </div>
</template>
