...
const returnColors = () => {
  switch (props.color) {
    ...
    case 'red':
      return 'bg-red-500 text-white hover:bg-red-600 focus:ring-red-500 dark:focus:ring-offset-gray-800'
    case 'green':
      return 'bg-green-500 text-white hover:bg-green-600 focus:ring-green-500 dark:focus:ring-offset-gray-800'
    case 'yellow':
